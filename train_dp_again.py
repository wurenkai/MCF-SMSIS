...
parser.add_argument('--trainlist', default='./filenames/SCARED17_train.txt', help='training list')
...
parser.add_argument('--lrepochs', type=str, default="300,500:10", help='the epochs to decay lr: the downscale rate')

parser.add_argument('--logdir', default='checkpoints/p3_sgdpdp', help='the directory to save logs and checkpoints')
parser.add_argument('--loadckpt_fe', default='checkpoints/p2_autolapedp/checkpoint_000019_fe.ckpt', help='load the weights from a specific checkpoint')
parser.add_argument('--loadckpt_de', default='checkpoints/p2_autolapedp/checkpoint_000019_de.ckpt', help='load the weights from a specific checkpoint')
...
if args.resume:
    ...
    #pre_dict_fe = {k: v for k, v in state_dict_fe['model_state_dict'].items() if k in fe_model_dict}
