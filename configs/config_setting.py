...
class setting_config:
    ...
    datasets = 'fuqiang_device'
    if datasets == 'ISIC2017':
        data_path = r'D:\data\data\ISIC_2017\\'
    elif datasets == 'ISIC2018':
        data_path = r'D:\data\data\ISIC_2018\\'
    elif datasets == 'xirou':
        data_path = r'D:\data\data\xirou\\'
    elif datasets == 'fuqiang_device':
        data_path = r'E:\data2\segment_fuqiang\download_2023-07-27_10-40-47\AutoLaparo_Task3\\'
    elif datasets == 't6k5':
        data_path = r'D:\code\33_CGI-Stereo\CGI-Stereo-main_seg+\seg_pre_t6k5\\'
    else:
